...
cat("1. The mean salary is", mean_salary, "which shows the average salary of the employees.\n")
cat("2. The median salary is", median_salary, "which is the middle value when the salaries are sorted in ascending order. This means that half of the employees earn less than", median_salary, "and half earn more.\n")
